...
- If the request changes the change's *intent* rather than refining it, recommend starting fresh with `/opsx-propose` (the "Update vs. Start Fresh" heuristic).
- Never implement repository changes, update task completion state, sync main specifications, or archive a change.
