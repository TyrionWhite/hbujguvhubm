---
description: Continue an existing change by creating its next ready planning artifacts
---
...
**Input**: Optionally specify a change name after `/opsx-continue`. If omitted and the change cannot be inferred unambiguously, run `openspec list --json` and use the **question tool** to let the user select.
